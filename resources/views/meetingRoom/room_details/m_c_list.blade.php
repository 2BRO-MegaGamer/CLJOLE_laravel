            ...
            <div id="HOST_item">
                <div class="dropdown">
                    <a class="list-group-item list-group-item-action d-flex gap-3 py-3" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img id="HOST_profile_img" can_fullscreen = "false" src="https://github.com/twbs.png" alt="twbs" width="32" height="32" class="rounded-circle flex-shrink-0">
                    ...
                    <div class="dropdown-menu  p-0 m-0 " style="max-width: fit-content;">
                        <div class="row w-100 p-0 m-0 ">
                            <button class="col btn btn-light rounded-0 text-secondary dropdown-toggle"  data-bs-toggle="modal" data-bs-target="#HOST_modal"><i class="bi bi-info-circle fs-4 p-0 m-0"></i></button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog">
                        ...
                        <button type="button" class="btn-close position-absolute top-0 end-0" data-bs-dismiss="modal" aria-label="Close"></button>
                            <div class="row mw-100 mh-100">
                                <div class="col-3">
                                <img id="HOST_profile_img_secend" can_fullscreen = "true" src="`+img_src+`" class="rounded-end w-100 h-100">
                                </div>
                                <div class="col-sm-9">
                                    <h5 class="modal-title">{{$HOST_userName}}<small class="opacity-75">{{$HOST_hashtag}}</small></h5>
                                </div>
                            </div>
                        </div>
                    </div>
