<div class="bg-secondary  w-100 h-100">
    <div id="webcam_or_voice_scroll_style" class="overflow-auto " style="max-height: 100%;">
        <div id="HOST_div_voice_video_card" class="card border-danger text-center mx-3 " style="margin-bottom: 5px;">
            <div id="HOST_voice_div" class="card-header p-1" style="background: rgb(255, 145, 0);">
                ...
                <div class="opacity-0 d-none" style="background: rgba(0, 0, 0, 0);">
                    <video id="HOST_voice_tag" width="0px" muted></video>
                </div>
            </div>
            <div id="HOST_video_div" class="w-100  position-relative d-none">
                <div class="h-100">
                    ...
                    <video id="HOST_video_tag" class="w-100 h-100" style="background: rgba(0, 0, 0, 0);" muted></video>
                </div>
            </div>
            <div  class="card-body p-0 m-0">
                <div class="position-relative border-top border-primary  rounded-bottom" style="background: rgb(255, 145, 0);">
                    <div id="HOST_voice_btn_div" class=" text-center">
